...
import { Droplets, Map, Mail, Phone, Instagram, Facebook, Send, Bike, Waves, Grape } from 'lucide-react';
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            <div className="flex items-center gap-2 text-blue-600 mb-1">
              ...
              <span className="font-medium text-sm uppercase tracking-wider">Niveau d'eau de la Loire</span>
            </div>
...
const FeatureCard = ({ icon: Icon, title, description, link }) => (
  <Card className="rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 border-gray-100 group h-full bg-white">
    <CardContent className="p-8 flex flex-col items-center text-center h-full">
      ...
      >
        <a href={link} className="inline-flex items-center gap-2 justify-center">
          En savoir plus
    ...
    <div className="min-h-screen bg-[#FDFBF7] font-sans text-slate-800">
      <header className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto mt-[-100px]">
          <h2 className="text-2xl md:text-3xl font-light mb-2 tracking-wide">L'aire de</h2>
          <h1 className="text-5xl md:text-7xl font-serif mb-6 tracking-tight">Chaumont-sur-Loire</h1>
          <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light leading-relaxed">
            Au cœur du Val de Loire, découvrez un territoire d'exception où patrimoine, nature et art de vivre se rencontrent
          </p>
        </div>
      </header>
      ...
      <section className="py-20 px-4 md:px-8 max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-serif text-emerald-900 mb-8">Bienvenue à l'Aire de Chaumont</h2>
        <p className="text-gray-600 leading-loose text-lg font-light">
          Vous êtes arrivés à un point de vue exceptionnel sur la Loire sauvage et le Domaine de Chaumont-sur-Loire. 
          Cette aire de repos, étape majeure de La Loire à Vélo, est le lieu idéal pour une pause. 
          Que ce soit pour vous détendre à la guinguette, découvrir l'histoire du port ou simplement admirer 
          le paysage classé au patrimoine mondial de l'UNESCO, votre escale commence ici.
        </p>
      </section>
      ...
      <section className="py-24 px-4 md:px-8 bg-[#FDFBF7]">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-serif text-emerald-900 mb-4">Être notifié des alertes</h2>
          <p className="text-gray-500 mb-10">Recevez les alertes liées au niveau de l'eau en temps réel sur votre boite mail</p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-3 opacity-80">
              <li><a href="#" className="hover:text-white transition-colors">Val de Loire</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Office de tourisme</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Domaine de Chaumont-sur-Loire</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Vigicrues</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a href="#" className="h-8 w-8 rounded-full bg-emerald-800 flex items-center justify-center hover:bg-emerald-700 transition-colors">
            ...
            <p className="opacity-60 text-xs leading-relaxed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Follow for daily garden inspiration and tips.
            </p>
          </div>
        </div>
      </footer>
